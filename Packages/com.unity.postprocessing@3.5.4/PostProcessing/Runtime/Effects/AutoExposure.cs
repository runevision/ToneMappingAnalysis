...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class AutoExposure : PostProcessEffectSettings
    {
        ...
        /// <summary>
        /// Reference average luminance to consider for auto exposure (in EV).
        /// </summary>
        [Range(LogHistogram.rangeMin, LogHistogram.rangeMax), DisplayName("Reference (EV)"), Tooltip("Reference average luminance to consider for auto exposure. Unit is EV.")]
        public FloatParameter refLuminance = new FloatParameter { value = 0f };

        /// <summary>
        /// How much the exposure adapts from the reference towards the average luminance.
        /// </summary>
        [Range(0.01f, 1.0f), DisplayName("Sensitivity"), Tooltip("How much the exposure adapts from the reference towards the average luminance.")]
        public FloatParameter sensitivity = new FloatParameter { value = 1f };
    ...
    internal sealed class AutoExposureRenderer : PostProcessEffectRenderer<AutoExposure>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            cmd.SetComputeVectorParam(compute, "_Params1", new Vector4(lowPercent * 0.01f, highPercent * 0.01f, settings.refLuminance.value, settings.sensitivity.value));
