...
namespace UnityEditor.Rendering.PostProcessing
{
    ...
    internal sealed class ColorGradingEditor : PostProcessEffectEditor<ColorGrading>
    {
        ...
        SerializedParameterOverride m_Whitening;
        ...
        public override void OnEnable()
        {
            ...
            m_Whitening = FindParameterOverride(x => x.whitening);
        ...
        void DoStandardModeGUI(bool hdr)
        {
            ...
            if (hdr)
            {
                ...
                if (m_Tonemapper.value.intValue == (int)Tonemapper.Custom || m_Tonemapper.value.intValue == (int)Tonemapper.TonyVibrant)
                {
                    DrawCustomToneCurve();
                ...
                if (m_Tonemapper.value.intValue == (int)Tonemapper.TonyVibrant)
                {
                    PropertyField(m_Whitening);
                }
            }
